...
enum opt_code
{
  ...
  OPT_mabi_ = 1270,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1271,             /* -mabort-on-noreturn */
  OPT_mandroid = 1272,                       /* -mandroid */
  OPT_mapcs = 1273,                          /* -mapcs */
  OPT_mapcs_frame = 1274,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1275,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1276,              /* -mapcs-stack-check */
  OPT_march_ = 1277,                         /* -march= */
  OPT_marm = 1278,                           /* -marm */
  OPT_masm_syntax_unified = 1279,            /* -masm-syntax-unified */
  OPT_mbe32 = 1280,                          /* -mbe32 */
  OPT_mbe8 = 1281,                           /* -mbe8 */
  OPT_mbig_endian = 1282,                    /* -mbig-endian */
  OPT_mbionic = 1283,                        /* -mbionic */
  OPT_mbranch_cost_ = 1284,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1285,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1286,     /* -mcaller-super-interworking */
  OPT_mcmse = 1287,                          /* -mcmse */
  OPT_mcpu_ = 1288,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1289,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1290,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1291,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1292,                  /* -mfp16-format= */
  OPT_mfpu_ = 1293,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1294,             /* -mgeneral-regs-only */
  OPT_mglibc = 1295,                         /* -mglibc */
  /* OPT_mhard_float = 1296, */              /* -mhard-float */
  OPT_mlittle_endian = 1297,                 /* -mlittle-endian */
  OPT_mlong_calls = 1298,                    /* -mlong-calls */
  OPT_mmusl = 1299,                          /* -mmusl */
  ...
  OPT_pie = 1343,                            /* -pie */
  OPT_pipe = 1344,                           /* -pipe */
  OPT_posix = 1345,                          /* -posix */
  OPT_print_file_name_ = 1346,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1347,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1348,          /* -print-multi-directory */
  OPT_print_multi_lib = 1349,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1350,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1351,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1352,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1353,               /* -print-prog-name= */
  OPT_print_search_dirs = 1354,              /* -print-search-dirs */
  OPT_print_sysroot = 1355,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1356,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1357,                        /* -profile */
  OPT_pthread = 1358,                        /* -pthread */
  OPT_quiet = 1359,                          /* -quiet */
  OPT_r = 1360,                              /* -r */
  OPT_rdynamic = 1361,                       /* -rdynamic */
  OPT_remap = 1362,                          /* -remap */
  OPT_s = 1363,                              /* -s */
  OPT_save_temps = 1364,                     /* -save-temps */
  OPT_save_temps_ = 1365,                    /* -save-temps= */
  OPT_shared = 1366,                         /* -shared */
  OPT_shared_libgcc = 1367,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1368,               /* -shared-libphobos */
  /* OPT_specs = 1369, */                    /* -specs */
  OPT_specs_ = 1370,                         /* -specs= */
  OPT_static = 1371,                         /* -static */
  OPT_static_libasan = 1372,                 /* -static-libasan */
  OPT_static_libgcc = 1373,                  /* -static-libgcc */
  ...
  OPT_static_libphobos = 1379,               /* -static-libphobos */
  OPT_static_libstdc__ = 1380,               /* -static-libstdc++ */
  OPT_static_libtsan = 1381,                 /* -static-libtsan */
  OPT_static_libubsan = 1382,                /* -static-libubsan */
  OPT_static_pie = 1383,                     /* -static-pie */
  /* OPT_std_c__03 = 1384, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1385, */                /* -std=c++0x */
  OPT_std_c__11 = 1386,                      /* -std=c++11 */
  OPT_std_c__14 = 1387,                      /* -std=c++14 */
  OPT_std_c__17 = 1388,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1389, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1390, */                /* -std=c++1z */
  OPT_std_c__2a = 1391,                      /* -std=c++2a */
  OPT_std_c__98 = 1392,                      /* -std=c++98 */
  OPT_std_c11 = 1393,                        /* -std=c11 */
  OPT_std_c17 = 1394,                        /* -std=c17 */
  /* OPT_std_c18 = 1395, */                  /* -std=c18 */
  /* OPT_std_c1x = 1396, */                  /* -std=c1x */
  OPT_std_c2x = 1397,                        /* -std=c2x */
  ...
  OPT_std_f2018 = 1405,                      /* -std=f2018 */
  OPT_std_f95 = 1406,                        /* -std=f95 */
  OPT_std_gnu = 1407,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1408, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1409, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1410,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1411,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1412,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1413, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1414, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1415,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1416,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1417,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1418,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1419, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1420, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1421,                      /* -std=gnu2x */
  ...
  /* OPT_std_iso9899_2017 = 1431, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1432, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1433,                     /* -std=legacy */
  OPT_symbolic = 1434,                       /* -symbolic */
  OPT_t = 1435,                              /* -t */
  OPT_time = 1436,                           /* -time */
  OPT_time_ = 1437,                          /* -time= */
  OPT_tno_android_cc = 1438,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1439,                 /* -tno-android-ld */
